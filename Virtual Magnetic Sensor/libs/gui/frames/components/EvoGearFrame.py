...
class EvoGearFrame(ObjectFrame):
    ...
    def __init__(self,
        ...
        super().__init__(master=master, title="EvoGear", data_handler=data_handler, config_handler=config_handler,
        ...
        self.entries['eccentricity'] = Gui.input_line(master=self.body_frame, config=config_handler.config, col=0,
                                                      row=3,
                                                      label="Eccentricity e :", unit="µm", col_shift=1)
        self.entries['wobble_angle'] = Gui.input_line(master=self.body_frame, config=config_handler.config, col=0,
                                                      row=4,
        ...
        self.entries['involute_points'] = Gui.input_line(master=self.sim_params_frame, config=config_handler.config,
                                                         col=0, row=2, label="Involute Points:", col_shift=1)
        self.entries['display_teeth_angle'] = Gui.vector2_input(master=self.sim_params_frame,
                                                                config=config_handler.config, col=0, row=3,
        ...
        self.entries['rotate_mesh_max_angle'] = Gui.input_line(master=self.sim_params_frame,
                                                               config=config_handler.config, col=0, row=5,
